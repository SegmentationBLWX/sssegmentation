...
- **2025-06-09**: This project has been updated quite frequently recently. If you prefer a more stable version, you may refer to the version available on PyPI or follow [this fork](https://github.com/CharlesPikachu/sssegmentation).
