'''deeplabv3_resnet50os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'deeplabv3_resnet50os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'deeplabv3_resnet50os16_cityscapes/deeplabv3_resnet50os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'deeplabv3_resnet50os16_cityscapes/deeplabv3_resnet50os16_cityscapes_results.pkl'