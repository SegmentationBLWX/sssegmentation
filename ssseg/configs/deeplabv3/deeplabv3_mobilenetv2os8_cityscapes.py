'''deeplabv3_mobilenetv2os8_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'deeplabv3_mobilenetv2os8_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'deeplabv3_mobilenetv2os8_cityscapes/deeplabv3_mobilenetv2os8_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'deeplabv3_mobilenetv2os8_cityscapes/deeplabv3_mobilenetv2os8_cityscapes_results.pkl'