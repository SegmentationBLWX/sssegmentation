'''psanet_resnet50os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'psanet_resnet50os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'psanet_resnet50os16_cityscapes/psanet_resnet50os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'psanet_resnet50os16_cityscapes/psanet_resnet50os16_cityscapes_results.pkl'