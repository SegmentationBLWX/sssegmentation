...
SEGMENTOR_CFG['work_dir'] = 'psanet_resnet50os8_voc'
SEGMENTOR_CFG['logfilepath'] = 'psanet_resnet50os8_voc/psanet_resnet50os8_voc.log'
SEGMENTOR_CFG['resultsavepath'] = 'psanet_resnet50os8_voc/psanet_resnet50os8_voc_results.pkl'