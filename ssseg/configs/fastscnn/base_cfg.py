...
SEGMENTOR_CFG = {
    ...
    'losses': {
        'loss_aux1': {'binaryceloss': {'scale_factor': 0.4, 'ignore_index': 255, 'reduction': 'mean'}},
        'loss_aux2': {'binaryceloss': {'scale_factor': 0.4, 'ignore_index': 255, 'reduction': 'mean'}},
        'loss_cls': {'binaryceloss': {'scale_factor': 1.0, 'ignore_index': 255, 'reduction': 'mean'}},
    },
    'inference': {
        'mode': 'whole',
        'opts': {}, 
    ...
    'scheduler': {
        'type': 'poly', 'max_epochs': 0, 'power': 0.9, 'min_lr': 1e-4,
        'optimizer': {
