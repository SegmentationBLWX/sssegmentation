'''mcibiplusplus_upernet_resnet50os8_voc'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'mcibiplusplus_upernet_resnet50os8_voc'
SEGMENTOR_CFG['logfilepath'] = 'mcibiplusplus_upernet_resnet50os8_voc/mcibiplusplus_upernet_resnet50os8_voc.log'
SEGMENTOR_CFG['resultsavepath'] = 'mcibiplusplus_upernet_resnet50os8_voc/mcibiplusplus_upernet_resnet50os8_voc_results.pkl'
