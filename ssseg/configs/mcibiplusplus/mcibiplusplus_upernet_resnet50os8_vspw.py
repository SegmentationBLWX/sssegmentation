'''mcibiplusplus_upernet_resnet50os8_vspw'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'mcibiplusplus_upernet_resnet50os8_vspw'
SEGMENTOR_CFG['logfilepath'] = 'mcibiplusplus_upernet_resnet50os8_vspw/mcibiplusplus_upernet_resnet50os8_vspw.log'
SEGMENTOR_CFG['resultsavepath'] = 'mcibiplusplus_upernet_resnet50os8_vspw/mcibiplusplus_upernet_resnet50os8_vspw_results.pkl'