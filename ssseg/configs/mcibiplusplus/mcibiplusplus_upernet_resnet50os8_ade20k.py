'''mcibiplusplus_upernet_resnet50os8_ade20k'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'mcibiplusplus_upernet_resnet50os8_ade20k'
SEGMENTOR_CFG['logfilepath'] = 'mcibiplusplus_upernet_resnet50os8_ade20k/mcibiplusplus_upernet_resnet50os8_ade20k.log'
SEGMENTOR_CFG['resultsavepath'] = 'mcibiplusplus_upernet_resnet50os8_ade20k/mcibiplusplus_upernet_resnet50os8_ade20k_results.pkl'