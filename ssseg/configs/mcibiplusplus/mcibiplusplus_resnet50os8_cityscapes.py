'''mcibiplusplus_resnet50os8_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'mcibiplusplus_resnet50os8_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'mcibiplusplus_resnet50os8_cityscapes/mcibiplusplus_resnet50os8_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'mcibiplusplus_resnet50os8_cityscapes/mcibiplusplus_resnet50os8_cityscapes_results.pkl'