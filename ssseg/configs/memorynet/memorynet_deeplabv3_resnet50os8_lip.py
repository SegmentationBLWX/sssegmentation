'''memorynet_deeplabv3_resnet50os8_lip'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'memorynet_deeplabv3_resnet50os8_lip'
SEGMENTOR_CFG['logfilepath'] = 'memorynet_deeplabv3_resnet50os8_lip/memorynet_deeplabv3_resnet50os8_lip.log'
SEGMENTOR_CFG['resultsavepath'] = 'memorynet_deeplabv3_resnet50os8_lip/memorynet_deeplabv3_resnet50os8_lip_results.pkl'