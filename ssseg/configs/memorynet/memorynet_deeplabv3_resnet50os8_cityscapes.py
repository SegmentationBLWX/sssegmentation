'''memorynet_resnet50os8_cityscapes'''
import os
...
COMMON_CFG['work_dir'] = 'memorynet_resnet50os8_cityscapes'
COMMON_CFG['logfilepath'] = 'memorynet_resnet50os8_cityscapes/memorynet_resnet50os8_cityscapes.log'
COMMON_CFG['resultsavepath'] = 'memorynet_resnet50os8_cityscapes/memorynet_resnet50os8_cityscapes_results.pkl'