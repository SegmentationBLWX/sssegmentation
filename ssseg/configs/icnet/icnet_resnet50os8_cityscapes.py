...
# deepcopy
SEGMENTOR_CFG = REGISTERED_SEGMENTOR_CONFIGS['ICNET_SEGMENTOR_CFG'].copy()
# modify dataset config
SEGMENTOR_CFG['dataset'] = REGISTERED_DATASET_CONFIGS['DATASET_CFG_CITYSCAPES_832x832'].copy()
