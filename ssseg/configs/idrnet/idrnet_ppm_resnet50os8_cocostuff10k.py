'''idrnet_ppm_resnet50os8_cocostuff10k'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'idrnet_ppm_resnet50os8_cocostuff10k'
SEGMENTOR_CFG['logfilepath'] = 'idrnet_ppm_resnet50os8_cocostuff10k/idrnet_ppm_resnet50os8_cocostuff10k.log'
SEGMENTOR_CFG['resultsavepath'] = 'idrnet_ppm_resnet50os8_cocostuff10k/idrnet_ppm_resnet50os8_cocostuff10k_results.pkl'