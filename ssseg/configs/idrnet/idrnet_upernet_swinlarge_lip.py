...
SEGMENTOR_CFG['work_dir'] = 'idrnet_upernet_swinlarge_lip'
SEGMENTOR_CFG['logfilepath'] = 'idrnet_upernet_swinlarge_lip/idrnet_upernet_swinlarge_lip.log'
SEGMENTOR_CFG['resultsavepath'] = 'idrnet_upernet_swinlarge_lip/idrnet_upernet_swinlarge_lip_results.pkl'
