'''idrnet_upernet_resnet50os8_ade20k'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'idrnet_upernet_resnet50os8_ade20k'
SEGMENTOR_CFG['logfilepath'] = 'idrnet_upernet_resnet50os8_ade20k/idrnet_upernet_resnet50os8_ade20k.log'
SEGMENTOR_CFG['resultsavepath'] = 'idrnet_upernet_resnet50os8_ade20k/idrnet_upernet_resnet50os8_ade20k_results.pkl'