'''idrnet_upernet_swinlarge_cocostuff10k'''
import copy
from .base_cfg import SEGMENTOR_CFG
from .._base_ import DATASET_CFG_COCOStuff10k_640x640, DATALOADER_CFG_BS16


# deepcopy
SEGMENTOR_CFG = copy.deepcopy(SEGMENTOR_CFG)
# modify dataset config
SEGMENTOR_CFG['dataset'] = DATASET_CFG_COCOStuff10k_640x640.copy()
...
SEGMENTOR_CFG['work_dir'] = 'idrnet_upernet_swinlarge_cocostuff10k'
SEGMENTOR_CFG['logfilepath'] = 'idrnet_upernet_swinlarge_cocostuff10k/idrnet_upernet_swinlarge_cocostuff10k.log'
SEGMENTOR_CFG['resultsavepath'] = 'idrnet_upernet_swinlarge_cocostuff10k/idrnet_upernet_swinlarge_cocostuff10k_results.pkl'
