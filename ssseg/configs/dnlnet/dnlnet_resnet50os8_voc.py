...
SEGMENTOR_CFG['work_dir'] = 'dnlnet_resnet50os8_voc'
SEGMENTOR_CFG['logfilepath'] = 'dnlnet_resnet50os8_voc/dnlnet_resnet50os8_voc.log'
SEGMENTOR_CFG['resultsavepath'] = 'dnlnet_resnet50os8_voc/dnlnet_resnet50os8_voc_results.pkl'