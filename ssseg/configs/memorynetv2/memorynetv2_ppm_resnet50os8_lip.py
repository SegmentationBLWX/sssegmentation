'''memorynetv2_ppm_resnet50os8_lip'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'memorynetv2_ppm_resnet50os8_lip'
SEGMENTOR_CFG['logfilepath'] = 'memorynetv2_ppm_resnet50os8_lip/memorynetv2_ppm_resnet50os8_lip.log'
SEGMENTOR_CFG['resultsavepath'] = 'memorynetv2_ppm_resnet50os8_lip/memorynetv2_ppm_resnet50os8_lip_results.pkl'