'''memorynetv2_upernet_resnet50os8_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'memorynetv2_upernet_resnet50os8_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'memorynetv2_upernet_resnet50os8_cityscapes/memorynetv2_upernet_resnet50os8_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'memorynetv2_upernet_resnet50os8_cityscapes/memorynetv2_upernet_resnet50os8_cityscapes_results.pkl'