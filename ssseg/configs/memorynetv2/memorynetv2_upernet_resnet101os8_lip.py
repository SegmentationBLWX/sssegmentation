'''memorynetv2_upernet_resnet101os8_lip'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'memorynetv2_upernet_resnet101os8_lip'
SEGMENTOR_CFG['logfilepath'] = 'memorynetv2_upernet_resnet101os8_lip/memorynetv2_upernet_resnet101os8_lip.log'
SEGMENTOR_CFG['resultsavepath'] = 'memorynetv2_upernet_resnet101os8_lip/memorynetv2_upernet_resnet101os8_lip_results.pkl'
...
SEGMENTOR_CFG['inference'] = {
    ...
    'tricks': {
        'multiscale': [0.75, 1, 1.25], 'flip': True, 'use_probs_before_resize': True
    }
}
'''