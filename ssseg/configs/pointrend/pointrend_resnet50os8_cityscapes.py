'''pointrend_resnet50os8_cityscapes'''
import os
...
COMMON_CFG['work_dir'] = 'pointrend_resnet50os8_cityscapes'
COMMON_CFG['logfilepath'] = 'pointrend_resnet50os8_cityscapes/pointrend_resnet50os8_cityscapes.log'
COMMON_CFG['resultsavepath'] = 'pointrend_resnet50os8_cityscapes/pointrend_resnet50os8_cityscapes_results.pkl'