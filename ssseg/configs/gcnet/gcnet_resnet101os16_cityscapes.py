'''gcnet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'gcnet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'gcnet_resnet101os16_cityscapes/gcnet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'gcnet_resnet101os16_cityscapes/gcnet_resnet101os16_cityscapes_results.pkl'