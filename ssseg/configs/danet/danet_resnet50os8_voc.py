...
SEGMENTOR_CFG['work_dir'] = 'danet_resnet50os8_voc'
SEGMENTOR_CFG['logfilepath'] = 'danet_resnet50os8_voc/danet_resnet50os8_voc.log'
SEGMENTOR_CFG['resultsavepath'] = 'danet_resnet50os8_voc/danet_resnet50os8_voc_results.pkl'