'''danet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'danet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'danet_resnet101os16_cityscapes/danet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'danet_resnet101os16_cityscapes/danet_resnet101os16_cityscapes_results.pkl'