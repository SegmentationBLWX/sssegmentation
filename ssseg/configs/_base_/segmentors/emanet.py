...
'''EMANET_SEGMENTOR_CFG'''
EMANET_SEGMENTOR_CFG = SegmentorConfig(
    type='EMANet',
    num_classes=-1,
    benchmark=True,
    align_corners=False,
    ...
    head={
        'in_channels': 2048, 'feats_channels': 512, 'momentum': 0.1, 'num_stages': 3, 'num_bases': 64, 'dropout': 0.1,
    },
    auxiliary={
    ...
    scheduler={
        ...
        'optimizer': {
            'type': 'SGD', 'lr': 0.01, 'momentum': 0.9, 'weight_decay': 5e-4, 'filter_params': True, 'params_rules': {},
        }
    },
    dataset=None,
    dataloader=None,
