'''SEGMENTOR_CFG for Deeplabv3'''
from .default_segmentor import SegmentorConfig


'''DEEPLABV3_SEGMENTOR_CFG'''
DEEPLABV3_SEGMENTOR_CFG = SegmentorConfig(
    benchmark=True,
    num_classes=-1,
    align_corners=False,
    type='Deeplabv3',
    ...
    head={
        'in_channels': 2048, 'feats_channels': 512, 'dilations': [1, 6, 12, 18], 'dropout': 0.1,
    },
    auxiliary={
