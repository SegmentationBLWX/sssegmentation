'''apcnet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'apcnet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'apcnet_resnet101os16_cityscapes/apcnet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'apcnet_resnet101os16_cityscapes/apcnet_resnet101os16_cityscapes_results.pkl'