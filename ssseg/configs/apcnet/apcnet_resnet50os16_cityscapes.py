'''apcnet_resnet50os16_cityscapes'''
import os
...
COMMON_CFG['work_dir'] = 'apcnet_resnet50os16_cityscapes'
COMMON_CFG['logfilepath'] = 'apcnet_resnet50os16_cityscapes/apcnet_resnet50os16_cityscapes.log'
COMMON_CFG['resultsavepath'] = 'apcnet_resnet50os16_cityscapes/apcnet_resnet50os16_cityscapes_results.pkl'