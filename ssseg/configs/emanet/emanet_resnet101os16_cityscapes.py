'''emanet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'emanet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'emanet_resnet101os16_cityscapes/emanet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'emanet_resnet101os16_cityscapes/emanet_resnet101os16_cityscapes_results.pkl'