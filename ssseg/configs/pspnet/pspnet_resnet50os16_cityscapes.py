'''pspnet_resnet50os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'pspnet_resnet50os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'pspnet_resnet50os16_cityscapes/pspnet_resnet50os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'pspnet_resnet50os16_cityscapes/pspnet_resnet50os16_cityscapes_results.pkl'