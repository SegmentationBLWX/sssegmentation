'''pspnet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'pspnet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'pspnet_resnet101os16_cityscapes/pspnet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'pspnet_resnet101os16_cityscapes/pspnet_resnet101os16_cityscapes_results.pkl'