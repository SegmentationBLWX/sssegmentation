'''dmnet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'dmnet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'dmnet_resnet101os16_cityscapes/dmnet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'dmnet_resnet101os16_cityscapes/dmnet_resnet101os16_cityscapes_results.pkl'