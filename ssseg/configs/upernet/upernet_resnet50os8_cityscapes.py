'''upernet_resnet50os8_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'upernet_resnet50os8_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'upernet_resnet50os8_cityscapes/upernet_resnet50os8_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'upernet_resnet50os8_cityscapes/upernet_resnet50os8_cityscapes_results.pkl'