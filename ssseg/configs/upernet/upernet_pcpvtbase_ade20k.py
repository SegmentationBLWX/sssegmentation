...
SEGMENTOR_CFG['backbone'] = {
    'type': 'pcpvt_base', 'series': 'twins', 'pretrained': True, 'selected_indices': (0, 1, 2, 3), 'norm_cfg': {'type': 'layernorm'},
}
SEGMENTOR_CFG['head'] = {
...
SEGMENTOR_CFG['work_dir'] = 'upernet_pcpvtbase_ade20k'
SEGMENTOR_CFG['logfilepath'] = 'upernet_pcpvtbase_ade20k/upernet_pcpvtbase_ade20k.log'
SEGMENTOR_CFG['resultsavepath'] = 'upernet_pcpvtbase_ade20k/upernet_pcpvtbase_ade20k_results.pkl'