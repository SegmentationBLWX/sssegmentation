'''upernet_resnet50os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'upernet_resnet50os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'upernet_resnet50os16_cityscapes/upernet_resnet50os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'upernet_resnet50os16_cityscapes/upernet_resnet50os16_cityscapes_results.pkl'