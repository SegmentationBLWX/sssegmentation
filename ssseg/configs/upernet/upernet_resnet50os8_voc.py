...
SEGMENTOR_CFG['work_dir'] = 'upernet_resnet50os8_voc'
SEGMENTOR_CFG['logfilepath'] = 'upernet_resnet50os8_voc/upernet_resnet50os8_voc.log'
SEGMENTOR_CFG['resultsavepath'] = 'upernet_resnet50os8_voc/upernet_resnet50os8_voc_results.pkl'