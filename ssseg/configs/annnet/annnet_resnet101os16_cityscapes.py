'''annnet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'annnet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'annnet_resnet101os16_cityscapes/annnet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'annnet_resnet101os16_cityscapes/annnet_resnet101os16_cityscapes_results.pkl'