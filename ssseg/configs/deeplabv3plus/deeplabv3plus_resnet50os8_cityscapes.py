'''deeplabv3plus_resnet50os8_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'deeplabv3plus_resnet50os8_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'deeplabv3plus_resnet50os8_cityscapes/deeplabv3plus_resnet50os8_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'deeplabv3plus_resnet50os8_cityscapes/deeplabv3plus_resnet50os8_cityscapes_results.pkl'