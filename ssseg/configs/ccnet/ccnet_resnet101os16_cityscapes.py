'''ccnet_resnet101os16_cityscapes'''
import copy
...
SEGMENTOR_CFG['work_dir'] = 'ccnet_resnet101os16_cityscapes'
SEGMENTOR_CFG['logfilepath'] = 'ccnet_resnet101os16_cityscapes/ccnet_resnet101os16_cityscapes.log'
SEGMENTOR_CFG['resultsavepath'] = 'ccnet_resnet101os16_cityscapes/ccnet_resnet101os16_cityscapes_results.pkl'