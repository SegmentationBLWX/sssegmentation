...
COMMON_CFG['train'].update(
    {
        'backupdir': 'danet_resnet50os8_cityscapes_train',
        'logfilepath': 'danet_resnet50os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'danet_resnet50os8_cityscapes_test',
        'logfilepath': 'danet_resnet50os8_cityscapes_test/test.log',
        'resultsavepath': 'danet_resnet50os8_cityscapes_test/danet_resnet50os8_cityscapes_results.pkl'
    }
)