...
COMMON_CFG['train'].update(
    {
        'backupdir': 'apcnet_resnet101os16_cityscapes_train',
        'logfilepath': 'apcnet_resnet101os16_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'apcnet_resnet101os16_cityscapes_test',
        'logfilepath': 'apcnet_resnet101os16_cityscapes_test/test.log',
        'resultsavepath': 'apcnet_resnet101os16_cityscapes_test/apcnet_resnet101os16_cityscapes_results.pkl'
    }
)