...
COMMON_CFG['train'].update(
    {
        'backupdir': 'nonlocalnet_resnet101os8_cityscapes_train',
        'logfilepath': 'nonlocalnet_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'nonlocalnet_resnet101os8_cityscapes_test',
        'logfilepath': 'nonlocalnet_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'nonlocalnet_resnet101os8_cityscapes_test/nonlocalnet_resnet101os8_cityscapes_results.pkl'
    }
)