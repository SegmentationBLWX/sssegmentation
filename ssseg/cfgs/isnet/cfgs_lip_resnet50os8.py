...
COMMON_CFG['train'].update(
    {
        'backupdir': 'isnet_resnet50os8_lip_train',
        'logfilepath': 'isnet_resnet50os8_lip_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'isnet_resnet50os8_lip_test',
        'logfilepath': 'isnet_resnet50os8_lip_test/test.log',
        'resultsavepath': 'isnet_resnet50os8_lip_test/isnet_resnet50os8_lip_results.pkl'
    }
)