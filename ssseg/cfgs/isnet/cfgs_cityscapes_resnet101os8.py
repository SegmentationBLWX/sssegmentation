...
COMMON_CFG['train'].update(
    {
        'backupdir': 'isnet_resnet101os8_cityscapes_train',
        'logfilepath': 'isnet_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'isnet_resnet101os8_cityscapes_test',
        'logfilepath': 'isnet_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'isnet_resnet101os8_cityscapes_test/isnet_resnet101os8_cityscapes_results.pkl'
    }
)