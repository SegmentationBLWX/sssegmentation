...
COMMON_CFG['train'].update(
    {
        'backupdir': 'encnet_resnet101os16_cityscapes_train',
        'logfilepath': 'encnet_resnet101os16_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'encnet_resnet101os16_cityscapes_test',
        'logfilepath': 'encnet_resnet101os16_cityscapes_test/test.log',
        'resultsavepath': 'encnet_resnet101os16_cityscapes_test/encnet_resnet101os16_cityscapes_results.pkl'
    }
)