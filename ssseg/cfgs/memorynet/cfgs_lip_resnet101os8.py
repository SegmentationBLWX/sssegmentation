...
COMMON_CFG['train'].update(
    {
        'backupdir': 'memorynet_resnet101os8_lip_train',
        'logfilepath': 'memorynet_resnet101os8_lip_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'memorynet_resnet101os8_lip_test',
        'logfilepath': 'memorynet_resnet101os8_lip_test/test.log',
        'resultsavepath': 'memorynet_resnet101os8_lip_test/memorynet_resnet101os8_lip_results.pkl'
    }
)