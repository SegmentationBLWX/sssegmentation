...
COMMON_CFG['train'].update(
    {
        'backupdir': 'memorynet_resnest101os8_cityscapes_train',
        'logfilepath': 'memorynet_resnest101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'memorynet_resnest101os8_cityscapes_test',
        'logfilepath': 'memorynet_resnest101os8_cityscapes_test/test.log',
        'resultsavepath': 'memorynet_resnest101os8_cityscapes_test/memorynet_resnest101os8_cityscapes_results.pkl'
    }
)