...
COMMON_CFG['train'].update(
    {
        'backupdir': 'memorynet_resnet50os8_lip_train',
        'logfilepath': 'memorynet_resnet50os8_lip_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'memorynet_resnet50os8_lip_test',
        'logfilepath': 'memorynet_resnet50os8_lip_test/test.log',
        'resultsavepath': 'memorynet_resnet50os8_lip_test/memorynet_resnet50os8_lip_results.pkl'
    }
)