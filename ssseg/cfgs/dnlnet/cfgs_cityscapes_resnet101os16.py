...
COMMON_CFG['train'].update(
    {
        'backupdir': 'dnlnet_resnet101os16_cityscapes_train',
        'logfilepath': 'dnlnet_resnet101os16_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'dnlnet_resnet101os16_cityscapes_test',
        'logfilepath': 'dnlnet_resnet101os16_cityscapes_test/test.log',
        'resultsavepath': 'dnlnet_resnet101os16_cityscapes_test/dnlnet_resnet101os16_cityscapes_results.pkl'
    }
)