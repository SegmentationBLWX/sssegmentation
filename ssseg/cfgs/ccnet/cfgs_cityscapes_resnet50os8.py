...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ccnet_resnet50os8_cityscapes_train',
        'logfilepath': 'ccnet_resnet50os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ccnet_resnet50os8_cityscapes_test',
        'logfilepath': 'ccnet_resnet50os8_cityscapes_test/test.log',
        'resultsavepath': 'ccnet_resnet50os8_cityscapes_test/ccnet_resnet50os8_cityscapes_results.pkl'
    }
)