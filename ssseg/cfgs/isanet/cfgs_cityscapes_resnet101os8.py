...
COMMON_CFG['train'].update(
    {
        'backupdir': 'isanet_resnet101os8_cityscapes_train',
        'logfilepath': 'isanet_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'isanet_resnet101os8_cityscapes_test',
        'logfilepath': 'isanet_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'isanet_resnet101os8_cityscapes_test/isanet_resnet101os8_cityscapes_results.pkl'
    }
)