...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fcn_resnest101os8_cityscapes_train',
        'logfilepath': 'fcn_resnest101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fcn_resnest101os8_cityscapes_test',
        'logfilepath': 'fcn_resnest101os8_cityscapes_test/test.log',
        'resultsavepath': 'fcn_resnest101os8_cityscapes_test/fcn_resnest101os8_cityscapes_results.pkl'
    }
)