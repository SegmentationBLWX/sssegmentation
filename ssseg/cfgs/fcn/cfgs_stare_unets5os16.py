...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fcn_unets5os16_stare_train',
        'logfilepath': 'fcn_unets5os16_stare_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fcn_unets5os16_stare_test',
        'logfilepath': 'fcn_unets5os16_stare_test/test.log',
        'resultsavepath': 'fcn_unets5os16_stare_test/fcn_unets5os16_stare_results.pkl'
    }
)