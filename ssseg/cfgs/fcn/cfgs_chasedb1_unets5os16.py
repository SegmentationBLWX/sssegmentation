...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fcn_unets5os16_chasedb1_train',
        'logfilepath': 'fcn_unets5os16_chasedb1_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fcn_unets5os16_chasedb1_test',
        'logfilepath': 'fcn_unets5os16_chasedb1_test/test.log',
        'resultsavepath': 'fcn_unets5os16_chasedb1_test/fcn_unets5os16_chasedb1_results.pkl'
    }
)