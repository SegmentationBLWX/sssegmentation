...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fcn_unets5os16_hrf_train',
        'logfilepath': 'fcn_unets5os16_hrf_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fcn_unets5os16_hrf_test',
        'logfilepath': 'fcn_unets5os16_hrf_test/test.log',
        'resultsavepath': 'fcn_unets5os16_hrf_test/fcn_unets5os16_hrf_results.pkl'
    }
)