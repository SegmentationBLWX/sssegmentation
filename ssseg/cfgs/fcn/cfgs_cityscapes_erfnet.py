'''define the config file for cityscapes and erfnet'''
import os
import torch
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fcn_erfnet_cityscapes_train',
        'logfilepath': 'fcn_erfnet_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fcn_erfnet_cityscapes_test',
        'logfilepath': 'fcn_erfnet_cityscapes_test/test.log',
        'resultsavepath': 'fcn_erfnet_cityscapes_test/fcn_erfnet_cityscapes_results.pkl'
    }
)