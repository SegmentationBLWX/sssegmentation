...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ce2p_resnet50os16_lip_train',
        'logfilepath': 'ce2p_resnet50os16_lip_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ce2p_resnet50os16_lip_test',
        'logfilepath': 'ce2p_resnet50os16_lip_test/test.log',
        'resultsavepath': 'ce2p_resnet50os16_lip_test/ce2p_resnet50os16_lip_results.pkl'
    }
)