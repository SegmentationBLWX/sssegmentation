...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ce2p_resnet101os16_cihp_train',
        'logfilepath': 'ce2p_resnet101os16_cihp_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ce2p_resnet101os16_cihp_test',
        'logfilepath': 'ce2p_resnet101os16_cihp_test/test.log',
        'resultsavepath': 'ce2p_resnet101os16_cihp_test/ce2p_resnet101os16_cihp_results.pkl'
    }
)