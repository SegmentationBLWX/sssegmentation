...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ce2p_resnet101os16_atr_train',
        'logfilepath': 'ce2p_resnet101os16_atr_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ce2p_resnet101os16_atr_test',
        'logfilepath': 'ce2p_resnet101os16_atr_test/test.log',
        'resultsavepath': 'ce2p_resnet101os16_atr_test/ce2p_resnet101os16_atr_results.pkl'
    }
)