...
COMMON_CFG['train'].update(
    {
        'backupdir': 'emanet_resnet101os16_cityscapes_train',
        'logfilepath': 'emanet_resnet101os16_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'emanet_resnet101os16_cityscapes_test',
        'logfilepath': 'emanet_resnet101os16_cityscapes_test/test.log',
        'resultsavepath': 'emanet_resnet101os16_cityscapes_test/emanet_resnet101os16_cityscapes_results.pkl'
    }
)