'''define the config file for cityscapes and deeplabv3-resnet50os32'''
import os
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fastfcn_deeplabv3_resnet50os32_cityscapes_train',
        'logfilepath': 'fastfcn_deeplabv3_resnet50os32_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fastfcn_deeplabv3_resnet50os32_cityscapes_test',
        'logfilepath': 'fastfcn_deeplabv3_resnet50os32_cityscapes_test/test.log',
        'resultsavepath': 'fastfcn_deeplabv3_resnet50os32_cityscapes_test/fastfcn_deeplabv3_resnet50os32_cityscapes_results.pkl'
    }
)