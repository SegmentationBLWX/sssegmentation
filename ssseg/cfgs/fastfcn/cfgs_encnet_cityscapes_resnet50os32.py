'''define the config file for cityscapes and encnet-resnet50os32'''
import os
...
LOSSES_CFG = {
    ...
    'loss_se': {
        'binaryceloss': {'scale_factor': 0.2, 'opts': {'reduction': 'mean'}}
    },
    'loss_cls': {
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'fastfcn_encnet_resnet50os32_cityscapes_train',
        'logfilepath': 'fastfcn_encnet_resnet50os32_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'fastfcn_encnet_resnet50os32_cityscapes_test',
        'logfilepath': 'fastfcn_encnet_resnet50os32_cityscapes_test/test.log',
        'resultsavepath': 'fastfcn_encnet_resnet50os32_cityscapes_test/fastfcn_encnet_resnet50os32_cityscapes_results.pkl'
    }
)