...
COMMON_CFG['train'].update(
    {
        'backupdir': 'deeplabv3_unets5os16_drive_train',
        'logfilepath': 'deeplabv3_unets5os16_drive_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'deeplabv3_unets5os16_drive_test',
        'logfilepath': 'deeplabv3_unets5os16_drive_test/test.log',
        'resultsavepath': 'deeplabv3_unets5os16_drive_test/deeplabv3_unets5os16_drive_results.pkl'
    }
)