'''define the config file for hrf and unets5os16'''
import os
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'deeplabv3_unets5os16_hrf_train',
        'logfilepath': 'deeplabv3_unets5os16_hrf_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'deeplabv3_unets5os16_hrf_test',
        'logfilepath': 'deeplabv3_unets5os16_hrf_test/test.log',
        'resultsavepath': 'deeplabv3_unets5os16_hrf_test/deeplabv3_unets5os16_hrf_results.pkl'
    }
)