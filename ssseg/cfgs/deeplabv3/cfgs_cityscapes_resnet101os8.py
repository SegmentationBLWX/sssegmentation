...
COMMON_CFG['train'].update(
    {
        'backupdir': 'deeplabv3_resnet101os8_cityscapes_train',
        'logfilepath': 'deeplabv3_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'deeplabv3_resnet101os8_cityscapes_test',
        'logfilepath': 'deeplabv3_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'deeplabv3_resnet101os8_cityscapes_test/deeplabv3_resnet101os8_cityscapes_results.pkl'
    }
)