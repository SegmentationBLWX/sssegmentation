...
COMMON_CFG['train'].update(
    {
        'backupdir': 'dmnet_resnet101os8_cityscapes_train',
        'logfilepath': 'dmnet_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'dmnet_resnet101os8_cityscapes_test',
        'logfilepath': 'dmnet_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'dmnet_resnet101os8_cityscapes_test/dmnet_resnet101os8_cityscapes_results.pkl'
    }
)