...
COMMON_CFG['train'].update(
    {
        'backupdir': 'annnet_resnet50os8_cityscapes_train',
        'logfilepath': 'annnet_resnet50os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'annnet_resnet50os8_cityscapes_test',
        'logfilepath': 'annnet_resnet50os8_cityscapes_test/test.log',
        'resultsavepath': 'annnet_resnet50os8_cityscapes_test/annnet_resnet50os8_cityscapes_results.pkl'
    }
)