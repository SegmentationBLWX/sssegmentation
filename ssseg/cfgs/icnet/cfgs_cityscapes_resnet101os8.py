...
COMMON_CFG['train'].update(
    {
        'backupdir': 'icnet_resnet101os8_cityscapes_train',
        'logfilepath': 'icnet_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'icnet_resnet101os8_cityscapes_test',
        'logfilepath': 'icnet_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'icnet_resnet101os8_cityscapes_test/icnet_resnet101os8_cityscapes_results.pkl'
    }
)