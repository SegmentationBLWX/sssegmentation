...
COMMON_CFG['train'].update(
    {
        'backupdir': 'upernet_swinsmall_ade20k_train',
        'logfilepath': 'upernet_swinsmall_ade20k_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'upernet_swinsmall_ade20k_test',
        'logfilepath': 'upernet_swinsmall_ade20k_test/test.log',
        'resultsavepath': 'upernet_swinsmall_ade20k_test/upernet_swinsmall_ade20k_results.pkl'
    }
)