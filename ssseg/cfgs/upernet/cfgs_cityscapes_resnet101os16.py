...
COMMON_CFG['train'].update(
    {
        'backupdir': 'upernet_resnet101os16_cityscapes_train',
        'logfilepath': 'upernet_resnet101os16_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'upernet_resnet101os16_cityscapes_test',
        'logfilepath': 'upernet_resnet101os16_cityscapes_test/test.log',
        'resultsavepath': 'upernet_resnet101os16_cityscapes_test/upernet_resnet101os16_cityscapes_results.pkl'
    }
)