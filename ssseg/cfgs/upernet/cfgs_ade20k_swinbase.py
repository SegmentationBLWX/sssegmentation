...
COMMON_CFG['train'].update(
    {
        'backupdir': 'upernet_swinbase_ade20k_train',
        'logfilepath': 'upernet_swinbase_ade20k_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'upernet_swinbase_ade20k_test',
        'logfilepath': 'upernet_swinbase_ade20k_test/test.log',
        'resultsavepath': 'upernet_swinbase_ade20k_test/upernet_swinbase_ade20k_results.pkl'
    }
)