...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ocrnet_resnet101os8_lip_train',
        'logfilepath': 'ocrnet_resnet101os8_lip_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ocrnet_resnet101os8_lip_test',
        'logfilepath': 'ocrnet_resnet101os8_lip_test/test.log',
        'resultsavepath': 'ocrnet_resnet101os8_lip_test/ocrnet_resnet101os8_lip_results.pkl'
    }
)