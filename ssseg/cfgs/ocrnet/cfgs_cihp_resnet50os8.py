'''define the config file for cihp and resnet50os8'''
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ocrnet_resnet50os8_cihp_train',
        'logfilepath': 'ocrnet_resnet50os8_cihp_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ocrnet_resnet50os8_cihp_test',
        'logfilepath': 'ocrnet_resnet50os8_cihp_test/test.log',
        'resultsavepath': 'ocrnet_resnet50os8_cihp_test/ocrnet_resnet50os8_cihp_results.pkl'
    }
)