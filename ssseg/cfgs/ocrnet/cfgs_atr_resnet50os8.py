'''define the config file for atr and resnet50os8'''
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ocrnet_resnet50os8_atr_train',
        'logfilepath': 'ocrnet_resnet50os8_atr_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ocrnet_resnet50os8_atr_test',
        'logfilepath': 'ocrnet_resnet50os8_atr_test/test.log',
        'resultsavepath': 'ocrnet_resnet50os8_atr_test/ocrnet_resnet50os8_atr_results.pkl'
    }
)