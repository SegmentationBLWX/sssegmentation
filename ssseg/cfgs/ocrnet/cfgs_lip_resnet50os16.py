'''define the config file for lip and resnet50os16'''
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ocrnet_resnet50os16_lip_train',
        'logfilepath': 'ocrnet_resnet50os16_lip_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ocrnet_resnet50os16_lip_test',
        'logfilepath': 'ocrnet_resnet50os16_lip_test/test.log',
        'resultsavepath': 'ocrnet_resnet50os16_lip_test/ocrnet_resnet50os16_lip_results.pkl'
    }
)