...
COMMON_CFG['train'].update(
    {
        'backupdir': 'pointrend_resnet101os8_cityscapes_train',
        'logfilepath': 'pointrend_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'pointrend_resnet101os8_cityscapes_test',
        'logfilepath': 'pointrend_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'pointrend_resnet101os8_cityscapes_test/pointrend_resnet101os8_cityscapes_results.pkl'
    }
)