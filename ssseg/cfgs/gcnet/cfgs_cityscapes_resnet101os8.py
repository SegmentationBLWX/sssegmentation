...
COMMON_CFG['train'].update(
    {
        'backupdir': 'gcnet_resnet101os8_cityscapes_train',
        'logfilepath': 'gcnet_resnet101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'gcnet_resnet101os8_cityscapes_test',
        'logfilepath': 'gcnet_resnet101os8_cityscapes_test/test.log',
        'resultsavepath': 'gcnet_resnet101os8_cityscapes_test/gcnet_resnet101os8_cityscapes_results.pkl'
    }
)