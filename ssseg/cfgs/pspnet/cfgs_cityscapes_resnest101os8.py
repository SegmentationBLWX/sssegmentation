...
COMMON_CFG['train'].update(
    {
        'backupdir': 'pspnet_resnest101os8_cityscapes_train',
        'logfilepath': 'pspnet_resnest101os8_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'pspnet_resnest101os8_cityscapes_test',
        'logfilepath': 'pspnet_resnest101os8_cityscapes_test/test.log',
        'resultsavepath': 'pspnet_resnest101os8_cityscapes_test/pspnet_resnest101os8_cityscapes_results.pkl'
    }
)