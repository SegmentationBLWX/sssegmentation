...
COMMON_CFG['train'].update(
    {
        'backupdir': 'pspnet_unets5os16_chasedb1_train',
        'logfilepath': 'pspnet_unets5os16_chasedb1_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'pspnet_unets5os16_chasedb1_test',
        'logfilepath': 'pspnet_unets5os16_chasedb1_test/test.log',
        'resultsavepath': 'pspnet_unets5os16_chasedb1_test/pspnet_unets5os16_chasedb1_results.pkl'
    }
)