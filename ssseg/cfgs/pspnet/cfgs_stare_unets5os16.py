...
COMMON_CFG['train'].update(
    {
        'backupdir': 'pspnet_unets5os16_stare_train',
        'logfilepath': 'pspnet_unets5os16_stare_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'pspnet_unets5os16_stare_test',
        'logfilepath': 'pspnet_unets5os16_stare_test/test.log',
        'resultsavepath': 'pspnet_unets5os16_stare_test/pspnet_unets5os16_stare_results.pkl'
    }
)