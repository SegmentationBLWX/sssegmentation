...
COMMON_CFG['train'].update(
    {
        'backupdir': 'pspnet_unets5os16_drive_train',
        'logfilepath': 'pspnet_unets5os16_drive_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'pspnet_unets5os16_drive_test',
        'logfilepath': 'pspnet_unets5os16_drive_test/test.log',
        'resultsavepath': 'pspnet_unets5os16_drive_test/pspnet_unets5os16_drive_results.pkl'
    }
)