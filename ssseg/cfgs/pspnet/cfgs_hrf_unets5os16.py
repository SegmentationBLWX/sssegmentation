...
COMMON_CFG['train'].update(
    {
        'backupdir': 'pspnet_unets5os16_hrf_train',
        'logfilepath': 'pspnet_unets5os16_hrf_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'pspnet_unets5os16_hrf_test',
        'logfilepath': 'pspnet_unets5os16_hrf_test/test.log',
        'resultsavepath': 'pspnet_unets5os16_hrf_test/pspnet_unets5os16_hrf_results.pkl'
    }
)