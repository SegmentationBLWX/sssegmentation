...
COMMON_CFG['train'].update(
    {
        'backupdir': 'psanet_resnet101os16_cityscapes_train',
        'logfilepath': 'psanet_resnet101os16_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'psanet_resnet101os16_cityscapes_test',
        'logfilepath': 'psanet_resnet101os16_cityscapes_test/test.log',
        'resultsavepath': 'psanet_resnet101os16_cityscapes_test/psanet_resnet101os16_cityscapes_results.pkl'
    }
)